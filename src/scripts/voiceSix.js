function dispatchByPan(pageId, functionName) {
	var param1 = document.getElementById("voiceSix.pan:input").value;
	if (param1) {
...
function dispatchByMerchant(pageId, functionName) {
	var param1 = document.getElementById("voiceSix.linkParamMerchantId:input").value;
	var param2 = document.getElementById("voiceSix.linkParamMandantId:input").value
	if (param1 && param2) {
...
function openPassByMerchant(passServer, mandantId) {
	var param = document.getElementById("voiceSix.linkParamMerchantId:input").value;
